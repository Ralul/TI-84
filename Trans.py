...
if (n1IsDefined and n2IsDefined and d1IsDefined == True):
    d2 = (n1*d1) / n2
    d2CalculationPath = ("d2 = (n1*d1) / n2")
    i = n1 / n2
    iCalculationPath = ("i = n1 / n2")

# n1 + n2 + d2  (2)
elif (n1IsDefined and n2IsDefined and d2IsDefined == True):
    d1 = (n2*d2) / n1
    d1CalculationPath = ("d1 = (n2*d2) / n1")
    i = n1 / n2
    iCalculationPath = ("i = n1 / n2")
...
# n1 + d1 + d2  (3)
    ...
    n2 = (n1*d1) / d2
    n2CalculationPath = ("n2 = (n1*d1) / d2")
    i = d2 / d1
    iCalculationPath = ("i = d2 / d1")

# n2 + d1 + d2  (4)
elif (n2IsDefined and d1IsDefined and d2IsDefined == True):
    n1 = (n2 * d2) / d1
    n1CalculationPath = ("n1 = (n2 * d2) / d1")
    i = d2 / d1
    iCalculationPath = ("i = n1 / n2")
...
print(n1CalculationPath)
print(n2CalculationPath)
print(d1CalculationPath)
print(d2CalculationPath)
print(iCalculationPath)
